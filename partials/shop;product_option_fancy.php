            ...
            <tbody>
                ...
                <? foreach ($values as $value): ?>        
                    <?
                        ...
                        $click_handler = "return $(this).getForm().sendRequest('on_action', {onAfterUpdate: init_effects, update: {'product_page': 'shop:product_partial'}, extraFields: { product_options: { '".$option_key."': '".h($value)."' } } })";
