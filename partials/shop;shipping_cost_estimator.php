...
<div class="shipping_estimator hidden" id="estimator_form">
  <div class="form">
    ...
    <a href="#" class="button_control" onclick="return $(this).getForm().sendRequest('shop:on_evalShippingRate', {update: {'shipping_options': 'shop:shipping_estimator_options'}})">OK</a>
  </div>
